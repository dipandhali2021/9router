...
- Docker Hub: [`dipandhali2021/9router`](https://hub.docker.com/r/dipandhali2021/9router)
- GHCR: [`ghcr.io/dipandhali2021/9router`](https://github.com/dipandhali2021/9router/pkgs/container/9router)
...
```bash
git clone https://github.com/dipandhali2021/9router.git
cd 9router
...
docker pull dipandhali2021/9router:latest   # update to latest
```
